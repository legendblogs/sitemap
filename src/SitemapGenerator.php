...
use Legendblogs\Crawler\Crawler;
use Legendblogs\Crawler\CrawlProfiles\CrawlProfile;
use Legendblogs\Sitemap\Crawler\Observer;
use Legendblogs\Sitemap\Crawler\Profile;
use Legendblogs\Sitemap\Tags\Url;
...
class SitemapGenerator
{
    ...
    /** @var \legendblogs\Crawler\Crawler */
    protected $crawler;
